...
interface Application {
  id: string; currentStatus: string; appliedPosition: string; createdAt: string; candidateId: string;
                      ...
                      >
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs text-slate-500 truncate mt-0.5">{a.appliedPosition}</p>
                          </div>
